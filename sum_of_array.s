...
#      Register $t0 intitially loads the address of X which is the address of the 1st element of the array.
#      Then, $t0 provides the address to load the value from that location into $t1. It then is incremented by 4
#      to increment to the address of the next array element. In summary, $t0 provides the address of each element of 
#      the array, ultimately allowing us to access the value at the address to add to the sum.
#
#
